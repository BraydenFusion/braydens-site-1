                ...
                <div className="mt-12 max-w-lg mx-auto">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <textarea required className="w-full mt-2 h-36 px-3 py-2 resize-none appearance-none bg-transparent outline-none border focus:border-[#00F0FF] shadow-sm rounded-lg"></textarea>
                        </div>
                        <button
                            className="w-full px-4 py-2 text-white font-medium bg-[#00F0FF] hover:bg-[#00D0E0] active:bg-[#00F0FF] rounded-lg duration-150"
                        >
                            Submit
                        </button>
                    </form>
